...
Project architecture, Firestore collections and the rules that must not be weakened for this
repository: `docs/PROJECT_ARCHITECTURE.md`. Read it before changing learning behaviour.
