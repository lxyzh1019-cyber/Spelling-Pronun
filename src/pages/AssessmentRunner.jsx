...
export default function AssessmentRunner() {
  ...
  // Seed-derived option order for this run of the form. The attempt session id already changes on every
  // retake, so a second sitting reshuffles and a resumed one does not. Audio choices keep their authored
  // order: see `shouldOrderChoices`.
  const orderedChoices = useMemo(() => (item ? orderChoices(item, attemptSessionId) : []), [item, attemptSessionId]);
