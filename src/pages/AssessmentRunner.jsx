...
export default function AssessmentRunner() {
  ...
  useEffect(() => {
    if (stateOwnerKey.current === storageKey && canWrite()) localStorage.setItem(storageKey, JSON.stringify(state));
  }, [canWrite, state, storageKey]);
  useEffect(() => {
