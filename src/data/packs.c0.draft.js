...
const spellingRows = [
  ...
  choice('Choose the word that completes “We ___ the results.”', 'c', [['a', 'analized'], ['b', 'annalysed'], ['c', 'analyzed']], 'Analyzed is an accepted Canadian spelling and uses yze in the base word analyze. Analyse and analysed are also used by Canadian writers, but analysed is not one of these choices.', 'canadian-ize'),
...
const punctuationRows = [
  ...
  choice('Which version best matches an excited exclamation?', 'c', [['a', 'What a remarkable view?'], ['b', 'What a remarkable view.'], ['c', 'What a remarkable view!']], 'The line expresses strong feeling rather than asking a question, so an exclamation mark fits.', 'exclamation-2'),
  ...
  choice('Which direct information question ends correctly?', 'b', [['a', 'Where should we meet.'], ['b', 'Where should we meet?']], 'Where should we meet directly asks for information and takes a question mark.', 'question-mark-2'),
...
const pronounRows = [
  ...
  choice('Choose the sentence that uses singular they correctly.', 'b', [['a', 'Someone left their bottle; them can claim it at the desk.'], ['b', 'Someone left their bottle; they can claim it at the desk.']], 'Singular they can refer to a person whose identity or gender is unknown, and they is the subject form.', 'singular-they'),
...
export const c0PilotPacks = [
  makePack('SP.patterns', 'Spelling Patterns', 'Use the base word, vowel pattern, and ending together. Patterns help predict spelling, but legitimate exceptions and variants must be taught explicitly.', ['Say the base word.', 'Mark the vowel and final letters.', 'Try the applicable pattern, then check for an exception.'], spellingRows, {
    ...
    sourceIds: [
      ...
      'ca-language-portal-double-consonant',
      'ca-language-portal-silent-e',
      'ca-language-portal-ending-c',
      'ca-language-portal-suffix-y',
      'ca-language-portal-prefix-in',
      'ca-language-portal-analyze',
      'ca-language-portal-canadian-spelling',
    ],
  }),
  ...
  makePack('PU.capitals-endmarks', 'Capitals and End Marks', 'Begin sentences and proper names with capitals. Choose a period, question mark, or exclamation mark from the sentence’s purpose.', ['Find the beginning and any proper names.', 'Decide whether the sentence states, asks, or strongly exclaims.', 'Check the matching final mark.'], punctuationRows, {
    ...
    sourceIds: [
      'ab-elal-2022-overview',
      'ca-language-portal-capitalization-general',
      'ca-language-portal-initial-words',
      'ca-language-portal-sentence-purpose',
      'ca-language-portal-personal-names',
      'ca-language-portal-family-capitals',
      'ca-language-portal-publication-capitals',
      'ca-language-portal-provinces-territories',
    ],
  }),
  makePack('GR.subject-object-pronouns', 'Subject and Object Pronouns', 'Use subject forms for who or what performs the action and object forms after verbs or prepositions.', ['Find the verb.', 'Ask who performs it and who receives it.', 'Remove the other noun in a compound to check the pronoun form.'], pronounRows, {
    ...
    sourceIds: [
      'ab-elal-2022-overview',
      'ab-eal-benchmarks-4-6',
      'ca-language-portal-personal-pronouns',
      'ca-language-portal-pronoun-case-quiz',
      'ca-language-portal-prepositions',
      'ca-language-portal-singular-they',
    ],
  }),
];
