...
const formBanks = {
  A: {
    ...
    sentences: [
      ...
      ['Choose the sentence with clear pronoun reference.', 'GR.antecedents', 'b', [['a', 'When Ava called Mia, she was outside.'], ['b', 'Ava was outside when she called Mia.']], 'In “Ava was outside when she called Mia.”, Ava is the sentence subject, and she clearly still refers to Ava.'],
      ...
      ['Choose the best repair for the fragment “Because the gate was locked.”', 'SE.fragments', 'a', [['a', 'We waited because the gate was locked.'], ['b', 'Because the locked gate.']], '“We waited because the gate was locked.” adds an independent clause, We waited, which completes the because-clause.'],
      ['Choose the best repair for “The bell rang, everyone entered.”', 'SE.runons', 'b', [['a', 'The bell, rang everyone entered.'], ['b', 'The bell rang, and everyone entered.']], '“The bell rang, and everyone entered.” joins the two complete thoughts with a comma and the conjunction and.'],
  ...
  B: {
    ...
    sentences: [
      ...
      ['Choose the sentence with clear pronoun reference.', 'GR.antecedents', 'a', [['a', 'Sofia put the book away after she read it.'], ['b', 'After Sofia spoke with Lina, she put the book away.']], 'In “Sofia put the book away after she read it.”, she refers to Sofia and it refers to the book. The other sentence leaves she unclear.'],
      ...
      ['Choose the best repair for the fragment “While the bus was waiting.”', 'SE.fragments', 'b', [['a', 'While waiting bus.'], ['b', 'We boarded while the bus was waiting.']], '“We boarded while the bus was waiting.” adds the independent clause We boarded, which completes the while-clause.'],
      ['Choose the best repair for “I found the date, I wrote it down.”', 'SE.runons', 'a', [['a', 'I found the date, so I wrote it down.'], ['b', 'I found, the date I wrote it down.']], '“I found the date, so I wrote it down.” joins the two complete thoughts with a comma and the conjunction so.'],
