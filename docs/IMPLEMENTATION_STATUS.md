...
- IndexedDB session snapshots and the attempt outbox are integrated locally; direct browser recovery after deliberately deleting/corrupting the localStorage mirror still needs a shared-browser harness, while remote reconciliation, C0 learner testing, Part-A integration, pronunciation capture, and the family pilot remain incomplete.
