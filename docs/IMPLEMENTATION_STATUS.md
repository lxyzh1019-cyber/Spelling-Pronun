...
| R2 full assessment runner | verified draft preview | Both 34-item forms integrated; browser verified synthetic audio control, exact resume, learner-isolated switching, and 20-item Part A → 14-item Part B transition; the current 38-test suite and production build pass |
