...
| EDU-01 | Codex | R2 | lesson packs educational/source reviewed; not released | `/case`, `lessonCatalog.js`, `lessonFlow.js`, `/lesson/:sessionId`, `reviews.c0.json`, `reviews.educational.c0.json`, `reviews.story.c0.json` | Browser completed the C0 spelling and capitals lessons; two misses produced a worked solution; `I don’t know yet` remained unresolved and entered guided repair; pause/back resumed that exact repair; all 96 lesson objects completed challenge and a separate educational/source review with explicit item ranges and source mappings; both story episodes completed challenge; reviewed lesson content remains excluded from mastery | Integrate and learner-test the lesson packs; complete separate educational/source review for the story before release |
...
| R1-G2 regressions | verified locally | Current `npm test`: 76/76; browser restart, skips, daily, crossword, learner ownership, reload checked |
...
| R2 C0 inventory | lesson packs reviewed; assessment/story challenge complete | Exact counts exist: 68 assessment prompts, four 24-object packs, and two story episodes. All 166 C0 objects/episodes completed recorded full-coverage challenge passes; all 96 lesson objects also completed a separate educational/source review. Everything remains blocked from release/mastery pending the remaining review, reviewed audio, integration, and learner testing |
...
| C0 chapter 1 | 2 episodes | 2 draft | 2 | 0 | 0 | 0 |
...
- Shared family identity, assessment/story educational review, full assessment release, sourced story chapters, pronunciation recording, and family pilot remain R2/R3 work.
