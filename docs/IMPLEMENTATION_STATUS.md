...
| EDU-01 | Codex | R2 | integrated draft preview; C0 challenge complete | `/case`, `lessonCatalog.js`, `lessonFlow.js`, `/lesson/:sessionId`, `reviews.c0.json`, `reviews.story.c0.json` | Browser completed the C0 spelling and capitals lessons; two misses produced a worked solution; `I don’t know yet` remained unresolved and entered guided repair; pause/back resumed that exact repair; all 96 lesson objects and both story episodes now have full challenge results; task-link tests prove each episode reaches exactly its linked lesson practice/transfers; eight lesson/story discrepancies were corrected and recorded | Complete the separate educational/source review before integration, learner testing, release, or mastery use |
...
| R1-G2 regressions | verified locally | Current `npm test`: 72/72; browser restart, skips, daily, crossword, learner ownership, reload checked |
...
| R2 C0 inventory | drafted / challenge complete | Exact counts exist: 68 assessment prompts, four 24-object packs, and two story episodes. All 166 C0 objects/episodes completed recorded full-coverage challenge passes; all remain blocked from release/mastery pending separate educational/source review, reviewed audio, integration, and learner testing |
...
| R2 full assessment runner | verified challenged preview | Both 34-item forms integrated and fully challenged; browser verified synthetic audio control, explicit pause/exact resume, rapid-submit protection, learner-isolated switching, speaking technical-failure continuation, exact route-interruption resume, and 20-item Part A → 14-item Part B transition; the current 72-test suite and production build pass |
| R2 delayed-review runner | integrated / content blocked | Pure tests verify reviewed-and-released-only admission, four-item cap, stable item/version pinning, feedback preservation, machine-evaluable routing, and completion; reviewed but unreleased content is explicitly excluded, as is challenged content; browser confirms C0 preview content cannot enter the mastery queue and its durable session bootstrap is error-free; 72 tests and production build pass | Complete educational/source review, integration, and learner testing, then browser-test correct, helped, omitted, revealed-repair, pause/resume, and schedule advancement with explicitly released items |
