...
| R1-G2 regressions | verified locally | Current `npm test`: 47/47; browser restart, skips, daily, crossword, learner ownership, reload checked |
...
| R2 engine build | verified locally | `npm run build`: 119 modules transformed; lazy learner routes emitted |
