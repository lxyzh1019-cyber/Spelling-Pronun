...
| R1-G2 regressions | verified locally | Current `npm test`: 68/68; browser restart, skips, daily, crossword, learner ownership, reload checked |
...
| R2 C0 inventory | drafting / lesson and assessment challenge complete | Exact counts exist: 68 assessment prompts, four 24-object packs, and two story episodes. All 164 lesson and assessment objects completed recorded full-coverage challenge passes; all remain blocked from release/mastery pending separate educational/source review and reviewed audio, while the story challenge remains open |
