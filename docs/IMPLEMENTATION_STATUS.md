...
| EDU-01 | Codex | R2 | integrated draft preview; 1/4 packs challenged | `/case`, `lessonCatalog.js`, `lessonFlow.js`, `/lesson/:sessionId`, `reviews.c0.json` | Browser completed the C0 spelling and capitals lessons; two misses produced a worked solution; `I don’t know yet` remained unresolved and entered guided repair; pause/back resumed that exact repair; reload resumed at question 2; six independent plus two transfer tasks led to reflection/evidence; all 24 `SE.complete` objects now have item-level challenge results against exact Canadian sources, with one minor explanation issue corrected | Complete educational/source review for `SE.complete`, then challenge and review the other three C0 packs before release/mastery |
...
| R2 C0 inventory | drafting / challenge underway | Exact counts exist: 68 assessment prompts, four 24-object packs, and two story episodes. The 24-object `SE.complete` pack completed its recorded challenge pass; all content remains blocked from release/mastery pending educational/source review and the remaining challenges |
...
| C0 four pilot packs | 96 objects | 96 draft | 24 | 0 | 0 | 0 |
