...
test('manifest proves exact C0 draft inventory without claiming release readiness', () => {
  ...
  assert.deepEqual(manifest.counts, { skills: 42, packs: 4, contentObjects: 96, assessmentPrompts: 68, episodes: 2, mappedSkills: 4, reviewedObjects: 0, reviewedAssessmentPrompts: 0 });
