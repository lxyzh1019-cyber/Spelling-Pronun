...
test('manifest proves exact C0 draft inventory without claiming release readiness', () => {
  ...
  assert.deepEqual(manifest.counts, { skills: 42, packs: 4, contentObjects: 96, assessmentPrompts: 68, episodes: 2, mappedSkills: 4, challengedObjects: 96, reviewedObjects: 96, challengedAssessmentPrompts: 68, reviewedAssessmentPrompts: 0, challengedEpisodes: 2, reviewedEpisodes: 2, releasedObjects: 0, releasedAssessmentPrompts: 0, releasedEpisodes: 0 });
