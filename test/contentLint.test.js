...
test('a complete-sentence question cannot be answered from the end mark alone', { todo: 'audit 2026-09-17 finding A2: 16 of 22 items in c0.pack.se.complete' }, () => {
...
test('a choice question offers at least three options', { todo: 'audit 2026-09-17 finding A3: 46 of 82 pack items and 36 of 40 form items' }, () => {
...
test('no distractor is obvious nonsense', { todo: 'audit 2026-09-17 finding A3: runnning, richh, makking, spl-endid' }, () => {
  const silly = [];
  for (const item of choiceItems) {
...
test('story prose is written at the reading level of its audience', { todo: 'audit 2026-09-17 finding B1: intros and reveals score 8.7-10.0, history notes 12.4-14.1' }, () => {
  const tooHard = [];
...
// lesson teaches.
test('lesson prompts and explanations are written at the reading level of their audience', { todo: 'audit 2026-09-17 finding B1: pack explanations average grade 5.5-7.9' }, () => {
  const tooHard = [];
